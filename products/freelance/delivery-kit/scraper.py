...
MAX_PAGES = 50                  # plasă de siguranță împotriva buclelor infinite
...
def main() -> int:
    ...
    while url and stats.pages < MAX_PAGES:
        ...
        # Dacă am configurat paginare dar nu se potrivește pe PRIMA pagină,
        # aproape sigur selectorul e greșit — nu situl care are o singură pagină.
        # Fără avertismentul ăsta, livrezi 20 de rânduri în loc de 1.000 și nu afli.
        if NEXT_PAGE_SELECTOR and nxt is None and stats.pages == 1:
            print(f"  ATENȚIE: selectorul de paginare «{NEXT_PAGE_SELECTOR}» nu se "
                  "potrivește pe prima pagină. Ori situl are o singură pagină, ori "
                  "selectorul e greșit — verifică înainte de livrare.", file=sys.stderr)
